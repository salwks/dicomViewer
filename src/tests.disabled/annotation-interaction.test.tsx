...
describe('EventBindingSystem', () => {
  ...
  describe('Click Options', () => {
    ...
    test('toggles multi-select option', async () => {
      ...
      const multiSelectSwitch = screen
        .getByText('Multi-select (Ctrl/Cmd)')
    ...
    test('toggles prevent default option', async () => {
      ...
      const preventDefaultSwitch = screen.getByText('Prevent Default').parentElement?.querySelector('[role="switch"]');
  ...
  describe('Empty States', () => {
    test('handles empty annotations array', () => {
      render(<EventBindingSystem viewportId='viewport-1' annotations={[]} selectionHandler={mockSelectionHandler} />);
