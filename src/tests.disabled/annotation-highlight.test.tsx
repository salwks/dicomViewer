...
describe('AnnotationHighlight', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    test('displays multiple selections correctly', () => {
      ...
      render(<AnnotationHighlight {...defaultProps} selectedAnnotationIds={selectedIds} />);
  ...
  describe('Style Interactions', () => {
    test('calls onHighlightStyleChange when preset is selected', () => {
      ...
      render(<AnnotationHighlight {...defaultProps} showControls={true} onHighlightStyleChange={mockOnStyleChange} />);
  ...
  describe('Canvas Interactions', () => {
    test('calls onAnnotationSelect when canvas is clicked', () => {
      ...
      render(<AnnotationHighlight {...defaultProps} onAnnotationSelect={mockOnSelect} />);
  ...
  describe('Empty States', () => {
    test('handles empty annotations array', () => {
      render(<AnnotationHighlight {...defaultProps} annotations={[]} selectedAnnotationIds={new Set()} />);

      expect(screen.getByText('0 selected')).toBeInTheDocument();
    });

    test('handles no selected annotations', () => {
      render(<AnnotationHighlight {...defaultProps} selectedAnnotationIds={new Set()} />);
  ...
  describe('Statistics Display', () => {
    ...
    test('updates statistics when selections change', () => {
      ...
      rerender(
        <AnnotationHighlight {...defaultProps} selectedAnnotationIds={new Set(['annotation-1', 'annotation-2'])} />
      );
