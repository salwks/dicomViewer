  ...
  describe('Alert Generation', () => {
    ...
    test('generates alert for critical memory pressure', done => {
      ...
      monitor.on('pressure-alert', (alert: MemoryPressureAlert) => {
        ...
        const hasAggressiveCleanup = alert.recommendations.some(rec => rec.action === 'aggressive-cleanup');
    ...
    test('generates alert for emergency memory pressure', done => {
      ...
      monitor.on('pressure-alert', (alert: MemoryPressureAlert) => {
        ...
        const hasEmergencyCleanup = alert.recommendations.some(rec => rec.action === 'emergency-cleanup');
