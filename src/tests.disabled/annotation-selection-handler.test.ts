...
describe('AnnotationSelectionHandler', () => {
  ...
  describe('Annotation Selection', () => {
    it('should select annotation successfully', () => {
      ...
      expect(AnnotationCompatLayer.selectAnnotation).toHaveBeenCalledWith(mockAnnotation, true, false);
    });
  ...
  describe('Selection Management', () => {
    it('should clear selection for viewport', () => {
      ...
      expect(AnnotationCompatLayer.selectAnnotation).toHaveBeenCalledWith(mockAnnotation, false, true);
    });
