(async ()=>{
    ...
    var __viteBrowserExternal$1 = Object.freeze({
        __proto__: null,
        default: __viteBrowserExternal
    });
    var require$$1 = getAugmentedNamespace(__viteBrowserExternal$1);
    var hasRequiredLibjpegturbowasm_decode;
    function requireLibjpegturbowasm_decode() {
        if (hasRequiredLibjpegturbowasm_decode) return libjpegturbowasm_decode.exports;
        hasRequiredLibjpegturbowasm_decode = 1;
        (function(module, exports) {
            var libjpegturbowasm_decode = (()=>{
                ...
                return function(libjpegturbowasm_decode2) {
                    ...
                    Module["INITIAL_MEMORY"] || 52428800;
                    var wasmTable;
                    var __ATPRERUN__ = [];
                    var __ATINIT__ = [];
                    var __ATPOSTRUN__ = [];
                    ...
                    Module["__embind_initialize_bindings"] = function() {
                        return (Module["__embind_initialize_bindings"] = Module["asm"]["Q"]).apply(null, arguments);
                    };
                    var _setThrew = Module["_setThrew"] = function() {
                        return (_setThrew = Module["_setThrew"] = Module["asm"]["R"]).apply(null, arguments);
                    };
                    ...
                    Module["dynCall_jiji"] = function() {
                        return (Module["dynCall_jiji"] = Module["asm"]["W"]).apply(null, arguments);
                    };
        ...
        return libjpegturbowasm_decode.exports;
    }
    var libjpegturbowasm_decodeExports = requireLibjpegturbowasm_decode();
    var libjpegTurboFactory = getDefaultExportFromCjs(libjpegturbowasm_decodeExports);
    const libjpegTurboWasm = new URL("/libjpegturbowasm_decode.wasm", import.meta.url);
    const local$5 = {
        codec: undefined,
        decoder: undefined
    };
    function initLibjpegTurbo() {
        ...
        return new Promise((resolve, reject)=>{
            libjpegTurboModule.then((instance)=>{
                local$5.codec = instance;
                local$5.decoder = new instance.JPEGDecoder();
                resolve();
            }, reject);
        });
    }
    async function decodeAsync$3(compressedImageFrame, imageInfo) {
        await initLibjpegTurbo();
        const decoder = local$5.decoder;
        ...
        const pixelData = getPixelData$3(frameInfo, decodedPixelsInWASM);
        const encodeOptions = {
            frameInfo
        };
        return {
    ...
    function getPixelData$3(frameInfo, decodedBuffer) {
    ...
    function initialize$4(decodeConfig) {
        local$4.decodeConfig = decodeConfig;
        if (local$4.JpegImage) {
            return Promise.resolve();
        }
        return new Promise((resolve, reject)=>{
            import('./jpeg.worker.js').then((module)=>{
                local$4.JpegImage = module.default;
                resolve();
            }).catch(reject);
        });
    }
    async function decodeJPEGBaseline12BitAsync(imageFrame, pixelData) {
        await initialize$4();
        if (typeof local$4.JpegImage === 'undefined') {
            throw new Error('No JPEG Baseline decoder loaded');
        }
        const jpeg = new local$4.JpegImage();
    ...
    function initialize$3(decodeConfig) {
        local$3.decodeConfig = decodeConfig;
        if (local$3.jpeg) {
            return Promise.resolve();
        }
        return new Promise((resolve, reject)=>{
            import('./lossless.worker.js').then(({ Decoder })=>{
                const decoder = new Decoder();
                local$3.jpeg = decoder;
                resolve();
            }, reject);
        });
    }
    async function decodeJPEGLossless(imageFrame, pixelData) {
        await initialize$3();
        if (typeof local$3.jpeg === 'undefined') {
            throw new Error('No JPEG Lossless decoder loaded');
        }
        const byteOutput = imageFrame.bitsAllocated <= 8 ? 1 : 2;
        const buffer = pixelData.buffer;
        const decompressedData = local$3.jpeg.decode(buffer, pixelData.byteOffset, pixelData.length, byteOutput);
        if (imageFrame.pixelRepresentation === 0) {
            if (imageFrame.bitsAllocated === 16) {
    ...
    var charlswasm_decode = {
        exports: {}
    };
    var hasRequiredCharlswasm_decode;
    function requireCharlswasm_decode() {
        if (hasRequiredCharlswasm_decode) return charlswasm_decode.exports;
        hasRequiredCharlswasm_decode = 1;
        (function(module, exports) {
            var CharLSWASM = (()=>{
                var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
                if (typeof __filename !== "undefined") _scriptDir = _scriptDir || __filename;
                return function(CharLSWASM2) {
                    ...
                    createWasm();
                    Module["___wasm_call_ctors"] = function() {
                        return (Module["___wasm_call_ctors"] = Module["asm"]["A"]).apply(null, arguments);
                    };
                    var _malloc = Module["_malloc"] = function() {
                    ...
                    Module["__embind_initialize_bindings"] = function() {
                        return (Module["__embind_initialize_bindings"] = Module["asm"]["E"]).apply(null, arguments);
                    };
                    var _free = Module["_free"] = function() {
        ...
        return charlswasm_decode.exports;
    }
    var charlswasm_decodeExports = requireCharlswasm_decode();
    var charlsFactory = getDefaultExportFromCjs(charlswasm_decodeExports);
    const charlsWasm = new URL("/charlswasm_decode.wasm", import.meta.url);
    const local$2 = {
        codec: undefined,
        decoder: undefined,
        decodeConfig: {}
    ...
    function getExceptionMessage(exception) {
        return typeof exception === 'number' ? local$2.codec.getExceptionMessage(exception) : exception;
    }
    function initialize$2(decodeConfig) {
        local$2.decodeConfig = decodeConfig;
        if (local$2.codec) {
            return Promise.resolve();
        }
        ...
        return new Promise((resolve, reject)=>{
            charlsModule.then((instance)=>{
                local$2.codec = instance;
                local$2.decoder = new instance.JpegLSDecoder();
                resolve();
            }, reject);
        });
    }
    async function decodeAsync$2(compressedImageFrame, imageInfo) {
        try {
            await initialize$2();
            const decoder = local$2.decoder;
            const encodedBufferInWASM = decoder.getEncodedBuffer(compressedImageFrame.length);
            encodedBufferInWASM.set(compressedImageFrame);
            decoder.decode();
            const frameInfo = decoder.getFrameInfo();
            ...
            const pixelData = getPixelData$2(frameInfo, decodedPixelsInWASM, imageInfo.signed);
            const encodeOptions = {
                nearLossless,
                interleaveMode,
                frameInfo
    ...
    function getPixelData$2(frameInfo, decodedBuffer, signed) {
    ...
    var openjpegwasm_decode = {
        exports: {}
    };
    var hasRequiredOpenjpegwasm_decode;
    function requireOpenjpegwasm_decode() {
        if (hasRequiredOpenjpegwasm_decode) return openjpegwasm_decode.exports;
        hasRequiredOpenjpegwasm_decode = 1;
        (function(module, exports) {
            var OpenJPEGWASM = (()=>{
                var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
                if (typeof __filename !== "undefined") _scriptDir = _scriptDir || __filename;
                return function(OpenJPEGWASM2) {
                    ...
                    var asmLibraryArg = {
                        ...
                        "h": __emval_decref,
                        "o": __emval_get_global,
                        "m": __emval_incref,
                        "n": __emval_new,
                        "p": __emval_take_value,
                        "i": _abort,
                        "v": _emscripten_get_heap_max,
                    ...
                    createWasm();
                    Module["___wasm_call_ctors"] = function() {
                        return (Module["___wasm_call_ctors"] = Module["asm"]["F"]).apply(null, arguments);
                    };
                    var _malloc = Module["_malloc"] = function() {
                    ...
                    Module["__embind_initialize_bindings"] = function() {
                        return (Module["__embind_initialize_bindings"] = Module["asm"]["K"]).apply(null, arguments);
                    };
                    var stackSave = Module["stackSave"] = function() {
                    ...
                    Module["dynCall_iji"] = function() {
                        return (Module["dynCall_iji"] = Module["asm"]["P"]).apply(null, arguments);
                    };
                    Module["dynCall_jji"] = function() {
                        return (Module["dynCall_jji"] = Module["asm"]["Q"]).apply(null, arguments);
                    };
                    Module["dynCall_iiji"] = function() {
                        return (Module["dynCall_iiji"] = Module["asm"]["R"]).apply(null, arguments);
                    };
                    Module["dynCall_jiji"] = function() {
        ...
        return openjpegwasm_decode.exports;
    }
    var openjpegwasm_decodeExports = requireOpenjpegwasm_decode();
    var openJpegFactory = getDefaultExportFromCjs(openjpegwasm_decodeExports);
    const openjpegWasm = new URL("/openjpegwasm_decode.wasm", import.meta.url);
    const local$1 = {
        codec: undefined,
        decoder: undefined,
        decodeConfig: {}
    };
    function initialize$1(decodeConfig) {
        local$1.decodeConfig = decodeConfig;
        if (local$1.codec) {
            return Promise.resolve();
        }
        ...
        return new Promise((resolve, reject)=>{
            openJpegModule.then((instance)=>{
                local$1.codec = instance;
                local$1.decoder = new instance.J2KDecoder();
                resolve();
            }, reject);
        });
    }
    async function decodeAsync$1(compressedImageFrame, imageInfo) {
        await initialize$1();
        const decoder = local$1.decoder;
        const encodedBufferInWASM = decoder.getEncodedBuffer(compressedImageFrame.length);
        encodedBufferInWASM.set(compressedImageFrame);
        decoder.decode();
        const frameInfo = decoder.getFrameInfo();
        ...
        const pixelData = getPixelData$1(frameInfo, decodedBufferInWASM);
        const encodeOptions = {
            imageOffset,
            numDecompositions,
            numLayers,
    ...
    function getPixelData$1(frameInfo, decodedBuffer) {
        if (frameInfo.bitsPerSample > 8) {
            if (frameInfo.isSigned) {
                return new Int16Array(decodedBuffer.buffer, decodedBuffer.byteOffset, decodedBuffer.byteLength / 2);
            }
    ...
    var hasRequiredOpenjphjs;
    function requireOpenjphjs() {
        if (hasRequiredOpenjphjs) return openjphjs.exports;
        hasRequiredOpenjphjs = 1;
        (function(module, exports) {
            var Module = (()=>{
                var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
                if (typeof __filename !== "undefined") _scriptDir = _scriptDir || __filename;
                return function(Module2) {
                    ...
                    Module2["INITIAL_MEMORY"] || 52428800;
                    var wasmTable;
                    var __ATPRERUN__ = [];
                    var __ATINIT__ = [];
                    var __ATPOSTRUN__ = [];
                    ...
                    Module2["__embind_initialize_bindings"] = function() {
                        return (Module2["__embind_initialize_bindings"] = Module2["asm"]["_embind_initialize_bindings"]).apply(null, arguments);
                    };
                    Module2["___errno_location"] = function() {
                        return (Module2["___errno_location"] = Module2["asm"]["__errno_location"]).apply(null, arguments);
                    };
        ...
        return openjphjs.exports;
    }
    var openjphjsExports = requireOpenjphjs();
    var openJphFactory = getDefaultExportFromCjs(openjphjsExports);
    const openjphWasm = new URL("/openjphjs.wasm", import.meta.url);
    const local = {
        codec: undefined,
        decoder: undefined,
        decodeConfig: {}
    ...
    function postProcessDecodedPixels(imageFrame, options, start, decodeConfig) {
        ...
        let invalidType = isColorImage(imageFrame.photometricInterpretation) && options.targetBuffer?.offset === undefined;
    ...
    function _handleTargetBuffer(options, imageFrame, typedArrayConstructors, pixelDataArray) {
        ...
        const length = rawLength !== null && rawLength !== undefined ? rawLength : imageFrameLength - offset;
    ...
    async function decodeImageFrame(imageFrame, transferSyntax, pixelData, decodeConfig, options, callbackFn) {
        ...
        switch(transferSyntax){
            ...
            case '1.2.840.10008.1.2.4.50':
                ...
                decodePromise = decodeAsync$3(pixelData, opts);
                break;
            case '1.2.840.10008.1.2.4.51':
                decodePromise = decodeJPEGBaseline12BitAsync(imageFrame, pixelData);
                break;
            ...
            case '1.2.840.10008.1.2.4.80':
                ...
                decodePromise = decodeAsync$2(pixelData, opts);
                break;
            ...
            case '1.2.840.10008.1.2.4.90':
                ...
                decodePromise = decodeAsync$1(pixelData, opts);
                break;
            ...
            case '1.2.840.10008.1.2.4.203':
                ...
                decodePromise = decodeAsync(pixelData, opts);
                break;
            default:
        ...
        const postProcessed = postProcessDecodedPixels(decodedFrame, options, start);
